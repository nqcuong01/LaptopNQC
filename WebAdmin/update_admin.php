        ...
        <div class="row ">
            ...
            <div class="col-xl-10 content"> 
                ...
                <form method="post">
                    ...
                    <p><span>Username:</span><input type="text" name="tUsername" value="<?php echo $fetched_row['username']; ?>"></p>
                    <p><span>Password:</span><input type="text" name="tPassword" value="<?php echo $fetched_row['password']; ?>"></p>
                    <p><span>Số điện thoại: </span><input type="text" name="tSodienthoai" value="<?php echo $fetched_row['sodienthoai']; ?>"></p>
                    <p>
                        <span>Cấp độ:</span>
                        <select name="tCapdo" >
                            <?php
                                if($fetched_row['capdo']=="Quản trị viên")
                                {
                                    echo "<option value=\"Quản trị viên\">Quản trị viên</option>";
                                    echo "<option value=\"Cộng tác viên\">Cộng tác viên</option>";
                                }
                                else
                                {
                                    echo "<option value=\"Cộng tác viên\">Cộng tác viên</option>";
                    ...
                    <p>
                        ...
                        <select name="tTrangthai">
                            <?php
                                if($fetched_row['trangthai']=="online")
                                {
                                    echo "<option value=\"online\">online</option>";
                                    echo "<option value=\"ofline\">ofline</option>";
                                }
                                else
                                {
                                    echo "<option value=\"ofline\">ofline</option>";
